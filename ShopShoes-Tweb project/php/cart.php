 ...
 * In this file there is the structure of the page relative to the cart of every single user.
 */
if(!isset($_SESSION)){
    session_start();
}
if(isset($_SESSION['username'],$_SESSION['name'],$_SESSION['surname'])) {
    ...
    /*End of navbar*/
    /*Start of the products section that will contain all items in the user’s cart*/
    include "../html/productsCart.html";
    /*End of product section and footer start*/
